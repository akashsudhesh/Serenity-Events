...
class _reguserState extends State<reguser> {
  late TextEditingController name, address, dob, phone, photo, username, password;
  var fil,objfile;
  ...
  void postdata() async {
    String url = login.url+"regusers/regu/";
  ...
  checkTextFieldEmptyOrNot(){
    ...
    if(text1 == '' || text3 == ''||text4 == '' || text5 == '' || text6 == ''||text7 == '' || text8 == '')
    {
            ...
            child: SingleChildScrollView(
              child: Column(
                children: [
                  Container(
                    child: Text(
                      "REGISTER YOUR BASIC ACCOUNT HERE", style: new TextStyle(
                        fontSize: 20,
